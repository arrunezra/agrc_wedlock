        ...
        <Box className="flex-1 absolute inset-0 z-[100]">
            ...
            >
                ...
                <Box className="absolute top-12 right-6 z-[110]">
                    <TouchableOpacity
                        onPress={onClose}
                        className="bg-white/10 p-3 rounded-full border border-white/20 backdrop-blur-md active:scale-90 transition-all"
                    >
                            ...
                            <VStack space="sm" className="w-full mt-4">
                                {onRetry && (
                                    <Button
                                        size="xl"
                                        onPress={onRetry}
                                        className="bg-white rounded-[20px] w-full h-16 shadow-2xl active:scale-[0.98]"
                                    >
